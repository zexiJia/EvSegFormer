...
from . import mix_transformer, mix_event_transformer

class WeTr(nn.Module):
    def __init__(self, backbone, num_classes=6, embedding_dim=256, pretrained=None):
        super().__init__()
        self.num_classes = num_classes
        self.embedding_dim = embedding_dim
        self.feature_strides = [4, 8, 16, 32]

        self.encoder = getattr(mix_event_transformer, backbone)()
